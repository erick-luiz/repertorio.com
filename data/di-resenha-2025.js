const repertorioDiResenha = {
    nome: "Grupo DiResenha Pel 2025",
    chave: "diresenha",
    blocos: [
        {
            nome: "SHOW DI RESENHA - INTRO - Vou querer de novo - A três  - Por Você-Febre-Quem de nós dois",
            musicas: ["Prefixo DiResenha", "Vou Querer Dnv - Thiaguinho", "A Três", "Por Voce (DR)", "Febre (DR)", "Quem de Nós Dois"]
        },
        {
            nome: "Apaguei pra todos - Me Bloqueia",
        ...
        {
            musicas: ["Falta de mim"]
        },
        {
            musicas: ["Ela", "Clichê", "Alucinado"]
        },
        {
            musicas: ["Daquele Jeitão"]
        },
        {
            musicas: ["Felina"]
        },
        {
            nome: "Zero a cem - Caju", 
